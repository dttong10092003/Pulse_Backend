...
const { getUserById, updateUser, createUserDetail, checkEmailOrPhoneExists, getUserByEmail, getUserDetailsByIds, getUserDetails, getTopUsersExcludingFollowed,getAllUsers } = require('../controllers/userController');
